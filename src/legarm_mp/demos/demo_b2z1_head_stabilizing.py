...
def main(argv):
    ...
    gripper_pos_0 = np.array([0.1572, 0., 0.2855])
    ...
    gripper_pos_1 = np.array([0.1572, 0., 0.2855])
    ...
    gripper_pos_2 = np.array([0.1572, 0., 0.2855])
    ...
    gripper_pos_3 = np.array([0.1572, 0., 0.2855])
    ...
    gripper_pos_4 = np.array([0.1572, 0., 0.2855])
    ...
    gripper_pos_5 = np.array([0.1572, 0., 0.2855])
    ...
    gripper_pos_6 = np.array([0.1572, 0., 0.2855])
    ...
    gripper_pos_7 = np.array([0.1572, 0., 0.2855])
    ...
    gripper_pos_8 = np.array([0.1572, 0., 0.2855])
    ...
    gripper_pos_9 = np.array([0.1572, 0., 0.2855])
    ...
    gripper_pos_10 = np.array([0.1572, 0., 0.2855])
    ...
    gripper_pos_11 = np.array([0.1572, 0., 0.2855])
